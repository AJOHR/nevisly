...
export default function NevislyLegend() {
  ...
  return <div className="relative">
    ...
    {open&&<div className="absolute right-0 top-10 z-50 max-h-[80vh] w-80 max-w-[90vw] space-y-4 overflow-auto rounded-xl border border-zinc-800 bg-zinc-950 p-4 text-xs text-zinc-400 shadow-xl">
      ...
      <p><strong className="text-zinc-200">Schedule</strong>: regular-season off-night access and Yahoo Weeks 24–26 are modeled separately. Regular-season off nights use projected per-game category value because those games are more likely to fit a daily lineup; playoff dates use exact C2/LW2/RW2/D4 allocation. Playoff off nights are excluded from the season term so Weeks 24–26 are not double counted. Missing schedules are neutral, and schedule never changes intrinsic Player Value.</p>
